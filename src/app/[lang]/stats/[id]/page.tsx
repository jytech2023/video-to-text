...
export default async function StatsDetailPage({
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      ...
      {/* Video */}
      {(() => {
        const embedUrl = getYouTubeEmbedUrl(record.url);
        if (!embedUrl && !record.videoUrl) return null;
        return (
          <section className="glass glow-purple rounded-2xl p-6 sm:p-8 mb-8">
